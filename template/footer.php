<footer id="footer">
    <div class="footer-nav">
        <div class="contact-and-links">
            ...
            <div class="links">
                <div class="accordion-container">
                    <div class="accordion">
                        ...
                        <div class="entry-panel">
                            <ul class="footer-links">
                                ...
                                <li><a href="<?php echo $root; ?>about-vision.php">Vision & Value</a></li>
                                <li><a href="<?php echo $root; ?>about-team.php">Our Team</a></li>
                                <li><a href="<?php echo $root; ?>about-showcase.php">Showcases</a></li>
                                <li><a href="<?php echo $root; ?>about-support.php">support</a></li>
                            </ul>
                        </div>
                        <ul class="footer-links show-md">
                            <li><a href="<?php echo $root; ?>about-history.php">History</a></li>
                            <li><a href="<?php echo $root; ?>about-vision.php">Vision & Value</a></li>
                            <li><a href="<?php echo $root; ?>about-team.php">Our Team</a></li>
                            <li><a href="<?php echo $root; ?>about-showcase.php">Showcases</a></li>
                    ...
                    <div class="accordion">
                        <h3 class="entry-title">LEARNING & OPPORTUNITIES</h3>
                        <div class="entry-panel">
                            <ul class="footer-links">
                                ...
                                <li><a href="<?php echo $root; ?>learning-opportunity.php">Student Opportunities</a></li>
                                <li><a href="<?php echo $root; ?>learning-opportunity.php">Researcher Opportunities</a></li>
                                <li><a href="<?php echo $root; ?>learning-opportunity.php">Staff Opportunities</a></li>
                            </ul>
                        </div>
                        <ul class="footer-links show-md">
                            <li><a href="<?php echo $root; ?>learning-program.php">Bachelor of Music Program (B.M.)</a></li>
                    ...
                    <div class="accordion">
                        ...
                        <div class="entry-panel">
                            <ul class="footer-links">
                                <li><a href="#link-out">Staff & Faculty</a></li>
                                <li><a href="#link-out">Alumni</a></li>
                                <li><a href="#link-out">Room Booking</a></li>
                                <li><a href="#link-out">Scholarships</a></li>
                                <li><a href="#link-out">Registration</a></li>
                                <li><a href="<?php echo $root; ?>service-external.php">External Services</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="accordion">
                        <h3 class="entry-title">Activities & Projects</h3>
                        <div class="entry-panel">
                            <ul class="footer-links">
                                <li><a href="<?php echo $root; ?>activities.php">Events and Activities</a></li>
                                <li><a href="<?php echo $root; ?>activities.php">Projects</a></li>
                            </ul>
                        </div>
                        <ul class="footer-links show-md">
                            <li><a href="<?php echo $root; ?>activities.php">Events and Activities</a></li>
                    ...
                    <div class="accordion">
                        <h3 class="entry-title">News & Announcement</h3>
                        <div class="entry-panel">
                            <ul class="footer-links">
                                <li><a href="<?php echo $root; ?>news.php">News</a></li>
                                <li><a href="<?php echo $root; ?>news.php">Announcement</a></li>
                                <li><a href="<?php echo $root; ?>news.php">Good Governance</a></li>
                            </ul>
                        </div>
                        <ul class="footer-links show-md">
                            <li><a href="<?php echo $root; ?>news.php">News</a></li>
        ...
        <div class="privacy-and-copyright">
            ...
            <p class="copyright">© 2025 Princess Galyani Vadhana Institute of Music. All rights reserved. ::*</p>
        </div>
    </div>
</footer>
...
<script src="<?php echo $root; ?>assets/js/library/jquery.deepest.min.js"></script>
